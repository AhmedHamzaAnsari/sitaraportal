...
$cart_id = $_GET['id'];
if ($pre != 'Admin') {
    $resultss = mysqli_query($db, "SELECT da.*,dc.name as vehicle_name FROM driving_alerts as da 
    join devicesnew as dc on dc.id=da.device_id
    where da.device_id=1222 and da.created_at>='2024-02-05 09:27:30' and da.created_at<='2024-03-08 09:27:30' order by da.id desc");
                                            ...
                                            function go_route() {
                                                ...
                                                if (date === "") {
                                                    ...
                                                    window.location.href =
                                                        'all_vehicles_alerts.php?id=<?php echo $_GET['id'] ?>&name=<?php echo $_GET['name'] ?>&from=' +
                                                        date + '&to=' +
                                                        dateto;
                                                }
                                    ...
                                    <div class="col-md-12">
                                        <form method="post" id="insert_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row mb-4">
                                                ...
                                                <input type="hidden" name="table_name" id="table_name" value="action_overspeed">
