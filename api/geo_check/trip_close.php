...
$sql_1="SELECT * FROM trip_sub where status='0' and consignee_id!='' and start_time >='$date_time';";
// echo $sql_1 ."<br>";
...
if($count_1 > 0) {
    while( $row = mysqli_fetch_array($result_1) ){
        ...
        $sql="SELECT ts.*,pos.lat as latitude, pos.lng as longitude FROM trip_sub as ts 
        join devicesnew as pos on ts.vehicle_id=pos.id 
...
function insert($v_id, $geo_id, $in_time, $sub_id, $consignee_name, $v_num) {
    ...
    $sql_check_geo="UPDATE trip_sub set status='1' where id='$sub_id'";
