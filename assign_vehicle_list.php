...
<?php
    ...
    $asset = "SELECT name ,uniqueId as id from devices";
    $resultdevice = mysqli_query($db, $asset); 

    $users = "SELECT * FROM users where privilege='Cartraige';";
    $resultusers = mysqli_query($db, $users); 

    $result = mysqli_query($db,"SELECT ur.name as username,dc.name,ud.users_id,ud.devices_id FROM users_devices_new as ud join users as ur on ur.id=ud.users_id join devicesnew as dc on dc.id=ud.devices_id where ur.name!='tracking_world' and ur.name!='sitara';");
                                        ...
                                        <div class="col-md-12">
                                            <button id="delete_btn" class="btn btn-danger">Delete</button>
                                                            ...
                                                            <table id="html5-extension"
                                                                class="table table-hover non-hover" style="width:100%">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">User namr</th>
                                    ...
                                    ?>
                                                        ...
                                                        value='<?= $row["uniqueId"]; ?>'></td> -->
                                                                        ...
                                                                        <td class="text-center"><a
                                                                                ...
                                                                                href="deleteuserdevice.php?users_id=<?php echo $row['users_id']; ?>&devices_id=<?php echo $row['devices_id']; ?>"
                                                                                data-toggle="tooltip"
