...
if (isset($_POST))
{
    ...
    if ($vehicle != "" && $from != "" && $to != "")
    {
        ...
        foreach ($date as $value)
        {
            ...
            // $users_arr = array();
            // $sql="SELECT * FROM `positionsnew` where time>='$from' and time<='$to' and device_id=$vehicle";
            $sql = "SELECT DATE_FORMAT(time,'%H:%i:%s') time,speed,power,odometer as imileage,vehicle_name as vehicle_id FROM positionsnew where device_id='$vehicle' and time>'$value 00:00:00' and time<'$value 04:59:59'  order by time asc";
            ...
            if ($number > 0)
            {
                ...
                $sql__2 = "SELECT MAX(pos.speed) as maxx,MIN(pos.speed) as minn, AVG(speed) AS Averagespeed FROM positionsnew as pos where pos.speed>0 and pos.device_id='$vehicle' and pos.time>'$value 00:00:00' and pos.time<'$value 23:59:59' order by pos.time asc;";
                ...
                $sql__3 = "SELECT(SELECT odometer as imileage FROM positionsnew where device_id='$vehicle' and time>'$value 00:00:00' and time<'$value 23:59:59'  order by time asc limit 1)  AS first,(SELECT odometer as imileage FROM positionsnew where device_id='$vehicle' and time>'$value 00:00:00' and time<'$value 23:59:59'  order by time desc limit 1)  AS last;";
