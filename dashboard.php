...
$data__=mysqli_fetch_array($result__);
    ...
    $result16=mysqli_query($db, "SELECT dc.name,dc.tracker as vehicle_make,dc.time,dc.speed,dc.location as vlocation ,dc.lat as latitude,dc.lng as longitude FROM users_devices_new as ud 
    join devicesnew as dc on dc.id=ud.devices_id where dc.speed>=60 and dc.time >='$prev_date' and ud.users_id='$id' and dc.time >= DATE_SUB(NOW(), INTERVAL 10 MINUTE)");
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#3b78b7 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $moving_devices; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#ea7372 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $stop_devices; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#e6b730 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $idle_devices; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#c34c9c !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $nr_devices; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#e62e2d !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $overspeed_devices; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row1["latitude"] .' , ' .$row1["longitude"]; ?></td>
                                            <td><?php echo $row1["speed"]; ?></td>
                                            <td><?php echo $row1["vehicle_make"]; ?></td>
