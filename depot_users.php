...
$Depot = "SELECT * FROM geofenceing where geotype='depot';";
$result_depot = mysqli_query($db, $Depot);
...
if(isset($_POST['submit'])){
    ...
    VALUES ('$name', 'Depot', '$email', '$encriped','1','1','$password','$email','$number')";
        // echo $sql;

    if (mysqli_query($db, $sql)) {
        $usersId = mysqli_insert_id($db);
        $sql_d = "INSERT INTO  depot_users (`user_id`,`depot_id`)VALUES ('$usersId', '$Depot')";
        if (mysqli_query($db, $sql_d)) {
            echo '<script>alert("New record created successfully")</script>';

        }
        else{
            echo "<script>alert('Error: Duplicate Email , Email already exist');</script>";
            echo "Error: " . $sql_d . "<br>" . mysqli_error($db);
        }
    } else {
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="depot_users.php" method="post">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="Depot" name="Depot" class="form-control selectpicker" data-live-search="true">
                                                            <option selected>Choose...</option>
                                                            <?php foreach($result_depot as $key => $value){ ?>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <a class="btn mx-2" href="manage_depot_users.php"
