...
$id = $_GET['id'];
$qry = mysqli_query($db,"SELECT * FROM geofenceing as geo left join consignee_contact as cc on cc.geo_id=geo.id where geo.id='$id'"); // select query
...
if(isset($_POST['add_geo'])){
    ...
    if (mysqli_query($db, $sql)) {
            ...
            $sql2 = "SELECT * FROM consignee_contact where geo_id='$geo_id';";
            echo $sql2;
            $totalrows = mysqli_num_rows((mysqli_query($db,$sql2)));

            if($totalrows > 0){
                // Delete record
                $update_contact = "UPDATE `consignee_contact`
                SET
                `contact_1` = '$cont_1',
                `contact_2` = '$cont_2'
                WHERE `geo_id` = '$geo_id';";
                
                if(mysqli_query($db,$update_contact)){
                    echo "<script>
                    ...
                    echo "Error: " . $update_contact . "<br>" . $db->error;
                  }
                
            }
            else{
                $create_contact = "INSERT INTO `consignee_contact`
                (`geo_id`,
                `contact_1`,
                `contact_2`)
                VALUES(
                ...
                if(mysqli_query($db,$create_contact)){
                    echo "<script>
                    alert('Record Updated successfully');
                    window.location.href='manage_geofence.php';
                    </script>";
                    ...
                    echo "Error: " . $create_contact . "<br>" . $db->error;
                }
                    ...
                    <div class="col-md-12" style="padding :0 !important">
                        ...
                        <div class="col-md-3"
                            ...
                            <div class="card component-card_9"
                                style="padding: 30px; width: 400px;height: 500px; overflow: auto;">
                                <form action="edit_consignee.php?id=<?php echo $id;?>" method="POST">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control input" id="name" name="name"
                                                value="<?php echo $data['consignee_name'] ?>" placeholder="Enter Name"
                                                required>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control input" id="address" name="address"
                                                value="<?php echo $data['location'] ?>" placeholder="Enter Address"
                                                required>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control input" id="code1" name="code1"
                                                value="<?php echo $data['code'] ?>" placeholder="Enter CODE 1" required
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control input" id="code2" name="code2"
                                                value="<?php echo $data['Code2'] ?>" placeholder="Enter CODE 2"
                                                required>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <input type="text" class="form-control input" id="condignee_no_1"
                                                name="condignee_no_1" value="<?php echo $data['contact_1'] ?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <input type="text" class="form-control input" id="condignee_no_2"
                                                name="condignee_no_2" value="<?php echo $data['contact_2'] ?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <select class="selectpicker" required data-width="100%" id="district"
                                                name="district">
                                                ...
                                                <option value="<?php echo $row_district['District'];?>">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <select class="selectpicker" required data-width="100%" id="province"
                                                name="province">
                                                ...
                                                <option value="<?php echo $row_province['Province'];?>">
                                                    <?php echo $row_province['Province'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <select class="selectpicker" required data-width="100%" id="salegroup"
                                                name="salegroup">
                                                <option value="<?php echo $data['Sales_Group'] ?>"><?php echo $data['Sales_Group'] ?></option>
                                                <option>Select Sales Group </option>
                                                <?php  while($row_salegroup = mysqli_fetch_array($salegroup_query)) { ?>
                                                <option value="<?php echo $row_salegroup['Sales_Group'];?>">
                                                    <?php echo $row_salegroup['Sales_Group'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <select class="selectpicker" required data-width="100%" id="slocation"
                                                name="slocation">
                                                <option value="<?php echo $data['Supply_Location'] ?>"><?php echo $data['Supply_Location'] ?></option>
                                                <option>Select Supply Location </option>
                                                <?php  while($row_slocation = mysqli_fetch_array($slocation_query)) { ?>
                                                <option value="<?php echo $row_slocation['Supply_Location'];?>">
                                                    <?php echo $row_slocation['Supply_Location'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <label for="" style="color: #fff;">Location Name <span>*</span></label> -->
                                            <select class="selectpicker" required data-width="100%" id="geotype"
                                                name="geotype">
                                                <option value="<?php echo $data['geotype'] ?>"><?php echo $data['geotype'] ?></option>
                                                <option>Select Geo Type </option>
                                                <?php  while($row_geotype = mysqli_fetch_array($geotype_query)) { ?>
                                                <option value="<?php echo $row_geotype['geotype'];?>">
                                                    <?php echo $row_geotype['geotype'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control input" id="lati" name="lati"
                                                value="<?php echo $data['Coordinates'] ?>"
...
<?php 
    ...
    function initMap() {
        ...
        var consignee_lat = <?php echo $c_lat?>;
        var consignee_lng = <?php echo $c_lng?>;

        const citymap = {

            newyork: {
                center: {
                    lat: parseFloat(consignee_lat),
                    lng: parseFloat(consignee_lng)
                },
                population: 800,
            },
