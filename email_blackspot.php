...
$cart_id = $_GET['id'];
if ($pre != 'Admin') {
    $resultss_black_spot = mysqli_query($db, "SELECT * FROM activity_blackspot_voiltion WHERE DATE(created_at) >= '$from' and DATE(created_at) <= '$to' and cartraige_id='$cart_id'");
                                        ...
                                        function go_route() {
                                            ...
                                            if (date === "") {
                                                ...
                                                window.location.href =
                                                    'email_blackspot.php?id=<?php echo $_GET['id'] ?>&name=<?php echo $_GET['name'] ?>&from=' +
                                                    date + '&to=' +
                                                    dateto;
                                            }
