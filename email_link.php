...
$cart_id = $_GET['id'];
if ($pre != 'Admin') {
    $resultss_night = mysqli_query($db, "SELECT * FROM activity_night_voilation_voiltion WHERE DATE(created_at) >= '$from' and DATE(created_at) <= '$to' and cartraige_id='$cart_id'");
