...
$cart_id = $_GET['id'];
if ($pre != 'Admin') {
    $resultss = mysqli_query($db, "SELECT * FROM activity_nr_voiltion WHERE DATE(created_at) >= '$from' and DATE(created_at) <= '$to' and cartraige_id='$cart_id'");
                                        ...
                                        <script>
                                            function go_route() {
                                                ...
                                                if (date === "") {
                                                    ...
                                                    window.location.href = 'email_nr.php?id=<?php echo $_GET['id'] ?>&name=<?php echo $_GET['name'] ?>&from=' + date + '&to=' +dateto;
                                                }
                                    ...
                                    <div class="col-md-12">
                                        <form method="post" id="insert_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row mb-4">
                                                ...
                                                <input type="hidden" name="table_name" id="table_name" value="action_nr">
