...
<head>
    ...
    $result12 = mysqli_query($db, "SELECT le.*,us.name FROM alert_email_link_verification as le 
    join users as us on us.id=le.cart_id
    where date='$from'");
    $all_devices = mysqli_num_rows($result12);



    $result13 = mysqli_query($db, "SELECT le.*,us.name FROM daily_close_alert_action as le 
    join users as us on us.id=le.cart_id
    where le.date='$from';");
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row">
                    ...
                    function forward_date() {
                        var from = $('#from').val();
                        if (from != "") {
                            window.location = "emails_dashboard.php?from=" + from + "";
                        } else {
                ...
                <div class="row layout-top-spacing ">
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#24245b !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#fff">Total Emails</h6>

                                            </div>
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $all_devices; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body" style="background:#3b78b7 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <svg style="box-shadow: 0px -1px 45px -1px rgba(255,255,255,1); border-radius: 50%;"
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#fff"> Respond Emails
                                                </h6>
                    ...
                    <!-- <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing" id="all_car">
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <center>
                                    <h3 style="color: #24245c;">All Emails</h3>
                                </center>
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row1["time_interval"]; ?></td>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing" id="moving_car">
                        <div class="widget-content widget-content-area br-6">
                                ...
                                <table id="html5-extension1" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $row["interval"]; ?>
                                            </td>
                                            <td>
                                                <?php echo $row["created_at"]; ?>
                                            </td>
                                            <td>
                                                <a href="email_close.php?id=<?php echo $row["cart_id"]; ?>&from=<?php echo $row["date"]; ?>&&name=<?php echo $row["name"]; ?>&interval=<?php echo $row["interval"]; ?>&e_id=<?php echo $row["email"]; ?>"
                                                    target="_blank">
