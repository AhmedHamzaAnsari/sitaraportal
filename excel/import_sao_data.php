        ...
        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            if ($ii != 1) {
                if ($emapData[0] != "" && $emapData[1] != "") {
                    ...
                    $sql = "SELECT * FROM sap_data_upload where delivery_no='$emapData[1]'";
                    ...
                    if ($count > 0) {
                        ...
                        if ($row['status'] == 0) {
                            if ($emapData[10] == 1 && $row['status'] == 0) {
                                // echo $emapData[10] . '<br>';
                                $update = "	UPDATE `sap_data_upload`
                                SET
                                `status` = 1 , close_time='$date' where delivery_no='$emapData[1]';";
                                // echo $update;
                        ...
                        } elseif ($row['status'] == 1 && $emapData[10] != 1) {

                            $sql = "INSERT INTO `sap_data_upload`
                            ( `tl_no`,
                            `delivery_no`,
                            `gi_posting_date`,
                            `sub_plant_name`,
                           ...
                           `planned_arrival_date`,
                            ...
                            $update = "	UPDATE `sap_data_upload`
                            SET
                            `dirversion` = 1 where delivery_no='$emapData[1]';";
                            // echo $update;
                            mysqli_query($db, $update);
                        }
                    } else {
