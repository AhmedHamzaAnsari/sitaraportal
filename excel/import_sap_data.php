...
<head>
    ...
    <title>Sap Data CSV Upload</title>
...
<body class="sidebar-noneoverflow starterkit">
                            ...
                            <div class="container-fluid mt-4">
                                <div class="row">
                                    ...
                                    <div class="span6" id="form-login">
                                        <form class="form-horizontal well" action="sap_uploader_new.php" method="post"
    ...
    <script>
    // Function to handle file selection and display CSV content
    function handleFile() {
        ...
        reader.onload = function(e) {
            ...
            // Parse CSV and create an HTML table
            const htmlTable = csvToHtmlTable(csvContent);
            // Display the HTML table in the container
            csvDataContainer.innerHTML = htmlTable;
        };

        reader.readAsText(file);
    }

    // Attach the handleFile function to the onchange event of the file input
    $('#csvFile').on('change', handleFile);
