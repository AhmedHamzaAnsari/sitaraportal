        ...
        <div class="submenu" id="trip">
            ...
            <ul class="submenu-list" data-parent-element="#trip">
                ...
                <li>
                        ...
                        <li>
                            <a href="../without_tracker_car.php"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg></span>Without tracker Vehicle </a>
                        </li>
                        <li>
                            <a href="../without_tracker_car.php"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg></span>Without tracker Vehicle </a>
                        </li>
