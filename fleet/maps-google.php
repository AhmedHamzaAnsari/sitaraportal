...
<body style="min-height: 700px;">
    ...
    <script>
        ...
        if (prev == 'Cartraige' || prev == 'End-User' || prev == 'karachi_base' || prev == 'dashboard') {
    ...
    <script
        src="https://maps.google.com/maps/api/js?key=AIzaSyBNyJWb04pByaU1CTmimoWNl3b86VV6qZ8&callback=myMap"></script>
    ...
    <script>
        function change_id() {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara/total.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                ...
                for (i = 0; i < 100; i++) {
                    ...
                    // if (diffDays > 1440) {
                    div = '' +
                        '                                                   <li class="list-unstyled" data-geo-lat="' + data[i]['lat'] + '" data-geo-long="' + data[i]['lng'] + '">' +
                        '                                                        <div class="card p-0  mb-1 ss" id="' + data[i]['id'] + '">' +
                        '                                                            <div class="card-body p-2">' +
                        ...
                        '                                                                        <p class="p-0 font-size-12 mb-1" id="' + data[i]['id'] + '-time">' + data[i]['time'] +
                        '                                                                        </p>' +
                        '                                                                    </div>' +
                        '                                                                </div>' +
                        ...
                        '                                                                                                        <i class="fas fa-building" style="color: rgb(240, 34, 96);"></i> ' + data[i]['trackername'] + '' +
                        '                                                                                                    </div>' +
                        '                                                                </div>' +
                        '                                                            </div>' +
                        '                                                        </div>' +
        ...
        function distributor() {
            ...
            $('#loading').show();
            $.ajax({
                url: "../sitara_api/sitara/distributor.php?accesskey=12345",
                method: "GET",
                timeout: 0,
                cache: false,
                success: function (response) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#dis').append('<li class="ss2" id="' + data[i]['distributor_id'] + '">' + data[i]['dis_name'] + '</li>');
        ...
        $('#dis').on('click', ".ss2", function () {
            ...
            $('#loading').show();
            $.ajax({
                url: "../sitara_api/sitara/end_user.php?dis=" + my_id + "&accesskey=12345",
                method: "GET",
                timeout: 0,
                cache: false,
                success: function (response) {
                    ...
                    const data = JSON.parse(response);
                    for (var i = 0; i < data.length; i++) {
                        $('#endu').append('<li class="ss3" id="' + data[i]['end_user_id'] + '">' + data[i]['enduser_name'] + '</li>');
                    }
        ...
        $(document).ready(function () {
            ...
            var refreshId = setInterval(function () {
                if (vehcile_selection.length == 1) {
                    ...
                    var settings = {
                        "url": "../sitara_api/sitara/selected_vehicle.php?vehi=" + vehcile_selection + "&accesskey=12345",
                        "method": "GET",
                        "timeout": 0,
                    };
                    //console.log("../sitara_api/sitara/selected_vehicle.php?vehi=" + vehcile_selection + "&accesskey=12345");
                    ...
                    $.ajax(settings).done(function (response) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            else if (ignition == 'ON' && speed > 0 && speed <= 50 && hoursDiff < 24) {
                                color = "#1D738D";
            ...
            $("#myInput").keydown(function () {
                ...
                ///Vehicle Search
                var settings = {
                    "url": "../sitara_api/sitara/vehi_search.php?accesskey=12345&str=" + filter + "&sel=" + sele+"&user="+user_id,
                    "method": "GET",
                    "timeout": 0,
                };
        ...
        function updated_data() {
            ...
            if (focused == 0) {
                ...
                var settings = {
                    "url": "../sitara_api/sitara/selected_vehicle.php?vehi=" + focused + "&accesskey=12345",
                    "method": "GET",
                    "timeout": 0,
                };
                //console.log("../sitara_api/sitara/selected_vehicle.php?vehi=" + focused + "&accesskey=12345");
        ...
        $("#stop").click(function () {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara/stopped_vehicle.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (ignition == "OFF") {
                        color = "red";
                        icon = "http://iot.trackfleetio.com/images/Advance_vehicletype/Truck_Stopped_NORTH.png";
                    }
                    else {
                        color = "green";
                        icon = "http://iot.trackfleetio.com/images/Advance_vehicletype/Truck_Running_NORTH.png";
                    }
                    var latlng = new google.maps.LatLng(data[i].lat, data[i].lng);
                    setMarker(data[i]['lat'], data[i]['lng'], data[i]['speed'], data[i]['id'], data[i]['name'], data[i]['location'], data[i]['time'], 'red', angle)
                    // markers.push(marker);
                }
            });
        });
        ...
        $("#nodata").click(function () {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara/nodata.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var icon;
                    var latlng = new google.maps.LatLng(data[i].lat, data[i].lng);
                    setMarker(data[i]['lat'], data[i]['lng'], data[i]['speed'], data[i]['id'], data[i]['name'], data[i]['location'], data[i]['time'], '#e62e2d', angle)
                    // markers.push(marker);
                }
            });
        });
        ...
        $("#running").click(function () {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara/running.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var latlng = new google.maps.LatLng(data[i].lat, data[i].lng);
                    setMarker(data[i]['lat'], data[i]['lng'], data[i]['speed'], data[i]['id'], data[i]['name'], data[i]['location'], data[i]['time'], '#1D738D', angle)
                    // markers.push(marker);
                }
        ...
        $("#idle").click(function () {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara/idle.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var latlng = new google.maps.LatLng(data[i].lat, data[i].lng);
                    setMarker(data[i]['lat'], data[i]['lng'], data[i]['speed'], data[i]['id'], data[i]['name'], data[i]['location'], data[i]['time'], 'yellow', angle)
                    // markers.push(marker);
                }
        ...
        $("#inactive").click(function () {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara/inactive.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var latlng = new google.maps.LatLng(data[i].lat, data[i].lng);
                    setMarker(data[i]['lat'], data[i]['lng'], data[i]['speed'], data[i]['id'], data[i]['name'], data[i]['location'], data[i]['time'], '#c34c9c', angle)
                    // markers.push(marker);
                }
            });
        });
        ...
        $('#d2').on('click', ".ss", function () {
            ...
            if (!aa.is('.bg-light')) {
                ...
                if (image_selected.indexOf(my_id) == -1) {
                    ...
                    var settings = {
                        "url": "../sitara_api/sitara/selected_vehicle.php?vehi=" + image_selected + "&accesskey=12345",
                        "method": "GET",
                        "timeout": 0,
                    };
        ...
        function activity() {
            var settings = {
                "url": "../sitara_api/sitara/running_count.php?vehi=" + focused + "&accesskey=12345",
                "method": "GET",
                "timeout": 0,
            };
        ...
        function speedo(id){
            var settings = {
                "url": "../sitara_api/sitara/speed.php?vehi=" + id + "&accesskey=12345",
                "method": "GET",
                "timeout": 0,
            };
        ...
        function basedata(id) {
            ...
            var settings = {
                "url": "../sitara_api/sitara/base_data.php?vehi=" + id + "&accesskey=12345",
                "method": "GET",
                "timeout": 0,
            };
        ...
        function drawpath() {
            var settings = {
                "url": "../sitara_api/sitara/route.php?vehi=" + focused + "&accesskey=12345",
                "method": "GET",
                "timeout": 0,
            };
        ...
        function callVehic(pager, offseter) {
            ...
            offset = offseter + 10;
            var settings = {
                "url": "../sitara_api/sitara/sitara_all_vehi.php?accesskey=12345&user=" + user_id + "&page=" + page + "&offset=" + offset,
                "method": "GET",
                "timeout": 0,
            };
        ...
        function count() {
            var settings = {
                "url": "../sitara_api/sitara/counts.php?accesskey=12345&user=" + user_id + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function (response) {
                const data = JSON.parse(response);
                $("#stop").html('<i class="far fa-stop-circle d-block font-size-16" style="color: rgb(250, 8, 8);"></i><b>' + data["stop"] + '</b>');
                $("#running").html('<i class="fas fa-location-arrow d-block font-size-16" style="color: rgb(29, 115, 141);"></i><b>' + data["running"] + '</b>');
                $("#idle").html('<i class="fas fa-hourglass-half d-block font-size-16" style="color: #E6B730;"></i><b>' + data["idle"] + '</b>');
                $("#inactive").html('<i class="fas fa-ban d-block font-size-16" style="color: #751386;"></i><b>' + data["inactive"] + '</b>');
                $("#nodata").html('<i class="fab fa-creative-commons-zero d-block font-size-16" style="color: #a70000;"></i><b>' + data["nodata"] + '</b>');
                $("#total").html('<i class="fas fa-check-double align-middle d-block font-size-16" style="color: rgb(89, 7, 184);"></i><b>' + data["total"] + '</b>');
            });
        }
