...
<head>
    <meta charset="utf-8">
    <title>Go Get Going With Go  Vehicle Track</title>
...
<body style="min-height: 700px;">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item bg-soft-light border-start border-end"
                            ...
                            <img class="rounded-circle header-profile-user" src="assets/images/gno.png"
                                alt="Header Avatar">
                            <span class="d-none d-xl-inline-block ms-1 fw-medium">Sitara Petroleum.</span>
                                        ...
                                        <div class="tab-content text-muted">
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <h5 class="pt-0">Date : <strong id="sap_update_date">---</strong>
                                                    </h5>
                                                    <!-- </h3> -->

                                                </div>

                                                <div class="row p-0" id='count_div'>
                                                    ...
                                                    <div class="col-2 mb-1 p-0 text-center"
                                                        title="Total Without Vehicles">
                                                        <button type="button" id="total_without_tracker"
                                                            class="btn btn-soft-primary waves-effect waves-light w-sm"
                                                            style="min-width: 60px !important;">
                                                            <i class="fas fa-danger align-middle d-block font-size-16"
                                                                style="color: rgb(89, 7, 184);"></i>
                                                    ...
                                                    <div class="col-2 mb-1 p-0 text-center" title="Total SAP Trip">
                                                        <button type="button" id="total_saps"
                                                            class="btn btn-soft-primary waves-effect waves-light w-sm"
                                                            style="min-width: 60px !important;">
                                                            <i class="fas fa-danger align-middle d-block font-size-16"
                                                                style="color: rgb(89, 7, 184);"></i>
    ...
    <div class="offcanvas offcanvas-end " style="width: 350px; margin-top: 70px;" tabindex="-1" id="offcanvasRight"
            ...
            <div class="row">
                <div class="col-md-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-1 p-0" id='sap_trip'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                                    ...
                                    <div class="row my-3">
                                        <form id="filter_form">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select id="depot_select" class="filter_select form-control">
                                                    <option value="Bakri Machike">Item 1</option>
                                                    <option value="HSD"> HSD</option>
                                                    <option value="Sahiwal Bulk">Item 3</option>
                                                    <!-- Add more options as needed -->
                                                </select>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="">Consignee</label>
                                                <select id="consignee_select" class="filter_select form-control">
                                                    <option value="Bakri Machike">Item 1</option>
                                                    <option value="HSD"> HSD</option>
                                                    <option value="Sahiwal Bulk">Item 3</option>
                                                    <!-- Add more options as needed -->
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select id="product_select" class="filter_select form-control">
                                                    <option value="Bakri Machike">Item 1</option>
                                                    <option value="HSD"> HSD</option>
                                                    <option value="Sahiwal Bulk">Item 3</option>
                                                    <!-- Add more options as needed -->
                    ...
                    <div class="card border border-primary">
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>Cartraige</h5>
                        </div>
                        <div class="card-body">
    ...
    function change_id() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/total.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
        ...
        $.ajax(settings).done(function(response) {
            ...
            for (i = 0; i < 100; i++) {
                ...
                div = '' +
                    ...
                    '                                                                            style="color: rgb(185, 8, 8);"></i> &nbsp; ' +
                    data[i]['sub_plant_name'] +
                    '                                                                    </div>' +
                    '                                                                </div>' +
                    '                                                                <div class="row p-0 mb-0 mt-0">' +
                    '                                                                    <div class="col-md-6">  ' +
                    ...
                    '                                                                    </div>' +
                    '                                                                    <div class="col-md-6" style="text-align: right;">' +
                    '                                                                                                        <i class="fas fa-house-user" style="color: rgb(240, 34, 96);"></i> ' +
                    data[i]['receiving_plant_name'] + ' - ' + data[i]['material_group'] +
                    '                                                                                                    </div>' +
                    '                                                                </div>' +
                    '                                                            </div>' +
                    '                                                        </div>' +
    ...
    function distributor() {
        ...
        $('#loading').show();
        $.ajax({
            url: "../sitara_api/sitara_sap_api/distributor.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
    ...
    function cartraige() {
        $.ajax({
            url: "../sitara_api/sitara_sap_api/cartraige.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
            success: function(response) {
                // $('.info').append(html);
                const data = JSON.parse(response);
                $('#cart_list').append('<li class="ss3" id="1">All</li>');
                for (var i = 0; i < data.length; i++) {
                    $('#cart_list').append('<li class="ss3" id="' + data[i]['id'] + '">' + data[i][
                        'name'
                    ] + '</li>');
                }
    ...
    function filter_select() {
        $.ajax({
            url: "../sitara_api/sitara_sap_api/get_sap_depot.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
            success: function(response) {
                ...
                const data = JSON.parse(response);
                $('#depot_select').empty();
                $('#depot_select').append('<option value="">Select</option>');

                for (var i = 0; i < data.length; i++) {
                    $('#depot_select').append('<option value="' + data[i]['depot'] + '">' + data[i][
                        'depot'
                    ] + '</option>');
                }
        ...
        $.ajax({
            url: "../sitara_api/sitara_sap_api/get_sao_consignee.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
            success: function(response) {
                // $('.info').append(html);
                const data = JSON.parse(response);
                $('#consignee_select').empty();
                $('#consignee_select').append('<option value="">Select</option>');

                for (var i = 0; i < data.length; i++) {
                    $('#consignee_select').append('<option value="' + data[i]['consignee'] + '">' + data[i][
                        'consignee'
                    ] + '</option>');
                }
        ...
        $.ajax({
            url: "../sitara_api/sitara_sap_api/get_sap_product.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
            success: function(response) {
                ...
                $('#product_select').append('<option value="">Select</option>');

                for (var i = 0; i < data.length; i++) {
                    $('#product_select').append('<option value="' + data[i]['product'] + '">' + data[i][
                        'product'
                    ] + '</option>');
                }
    ...
    function get_sao_trips(vehi) {
        // alert(vehi)
        $.ajax({
            url: "../sitara_api/sitara_sap_api/get_trips.php?accesskey=12345&vehi=" +
                vehi + "",
            method: "GET",
            timeout: 0,
            cache: false,
            success: function(response) {
                ...
                $('#sap_trip').empty();
                for (var i = 0; i < data.length; i++) {
                    $('#sap_trip').append('<div class="row">' +
                        '<p>Trip # ' + (i + 1) + '</p>' +
                        '<div class="col-4">' +
                        ' <p style="margin-left:10px">Sap #</p>' +
                        ' </div>' +
                        ' <div class="col-8 d-flex justify-content-end">' +
                        ' <p style="margin-right: 10px;">' + data[i]['delivery_no'] + '</p>' +
                        ' </div>' +
                        ' <div class="col-4">' +
                        ' <p style="margin-left:10px">Sub Plant</p>' +
                        ' </div>' +
                        ' <div class="col-8 d-flex justify-content-end">' +
                        ' <p style="margin-right: 10px;">' + data[i]['sub_plant_name'] + '</p>' +
                        ' </div>' +
                        ' <div class="col-4">' +
                        ' <p style="margin-left:10px">Consignee</p>' +
                        ' </div>' +
                        ' <div class="col-8 d-flex justify-content-end">' +
                        ' <p style="margin-right: 10px;">' + data[i]['receiving_plant_name'] + '</p>' +
                        ' </div>' +
                        ' <div class="col-4">' +
                        ' <p style="margin-left:10px">Product</p>' +
                        ' </div>' +
                        ' <div class="col-8 d-flex justify-content-end">' +
                        ' <p style="margin-right: 10px;">' + data[i]['material_group'] + '</p>' +
                        ' </div>' +
                        ' <div class="col-4">' +
                        '<p style="margin-left:10px">Qty</p>' +
                        ' </div>' +
                        ' <div class="col-8 d-flex justify-content-end">' +
                        ' <p style="margin-right: 10px;">' + data[i]['gi_qty'] + '</p>' +
                        '</div>' +
                        '<div class="col-4">' +
                        '<p style="margin-left:10px">Driver Name</p>' +
                        '</div>' +
                        '<div class="col-8 d-flex justify-content-end">' +
                        '<p style="margin-right: 10px;">' + data[i]['driver_contact'] + '</p>' +
                        ' </div>' +
                        '<div class="col-4">' +
                        ' <p style="margin-left:10px">Driver CNIC</p>' +
                        '</div>' +
                        '<div class="col-8 d-flex justify-content-end">' +
                        '<p style="margin-right: 10px;">' + data[i]['driver_cnic'] + '</p>' +
                        '</div>' +
                        ' <div class="col-4">' +
                        '<p style="margin-left:10px">Driver Contact</p>' +
                        '</div>' +
                        '<div class="col-8 d-flex justify-content-end">' +
                        '<p style="margin-right: 10px;">' + data[i]['driver_name'] + '</p>' +
                        '</div>' +
                        '</div');
                }
    ...
    $('#dis').on('click', ".ss2", function() {
        ...
        $('#loading').show();
        $.ajax({
            url: "../sitara_api/sitara_sap_api/end_user.php?dis=" + my_id +
                "&accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
    ...
    $('#endu , #cart_list').on('click', ".ss3", function() {
        setMapOnAll(null);
        markersArray = [];
    ...
    const $searchSelect = $('.filter_select');
    const $list = $('#d2');
    ...
    $searchSelect.on('change', function() {
        ...
        // Iterate through each <li> element within the list
        $list.find('li').each(function() {
            const listItemText = $(this).text().toLowerCase();

            // Check if the text contains the search text
            const isVisible = listItemText.includes(searchText);

            // Show or hide the <li> element based on the search result
    ...
    $(document).ready(function() {
        ...
        var refreshId = setInterval(function() {
            if (vehcile_selection.length == 1) {
                ...
                var settings = {
                    "url": "../sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" +
                        vehcile_selection + "&accesskey=12345",
                    "method": "GET",
                    "timeout": 0,
                };
                //console.log("../sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" + vehcile_selection + "&accesskey=12345");
        ...
        $("#myInput").keyup(function() {
            ...
            ///Vehicle Search
            var settings = {
                "url": "../sitara_api/sitara_sap_api/vehi_search.php?accesskey=12345&str=" +
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    if (sele == 1) {
                        div = '' +
                            ...
                            '                                                                    <div class="col-md-6" style="text-align: right;">' +
                            '                                                                                                        <i class="fas fa-house-user" style="color: rgb(240, 34, 96);"></i> ' +
                            data[i]['receiving_plant_name'] + ' - ' + data[i][
                                'material_group'
                            ] +
                            '                                                                                                    </div>' +
                            '                                                                </div>' +
    ...
    function updated_data() {
        ...
        if (focused == 0) {
            ...
            var settings = {
                "url": "../sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" + focused +
                    "&accesskey=12345",
                "method": "GET",
                "timeout": 0,
            };
            //console.log("../sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" + focused + "&accesskey=12345");
    ...
    $("#stop").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/stopped_vehicle.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#nodata").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/nodata.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#running").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/running.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#idle").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/idle.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    ///INACTIVE
    $("#total_without_tracker").click(function() {
        sele = 4;
        var myLatlng = new google.maps.LatLng(30.3753, 69.3451)
        map.setZoom(5);
        map.setCenter(myLatlng);
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/with_out_tracker.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
        ...
        $.ajax(settings).done(function(response) {
            ...
            for (i = 0; i < l; i++) {
                ...
                div = '' +
                    ...
                    '<div class="card p-0 no_tracker mb-1 " data-geo-lat="' + data[i]['lat'] +
                    '" data-geo-long="' + data[i]['lng'] + '" data-geo-long="' + data[i]['idds'] +
                    '" data-car_name="' + data[i]['name'] + '" data-idds="' + data[i]['id'] +
                    '"  id="' +
                    data[i]['id'] + '">' +
                    '                                                            <div class="card-body p-2">' +
                    '                                                                <div class="row p-0 mb-0 ">' +
    ...
    $("#inactive").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "../sitara_api/sitara_sap_api/inactive.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $('#d2').on('click', ".ss", function() {
        ...
        if (!aa.is('.bg-light')) {
            ...
            if (image_selected.indexOf(my_id) == -1) {
                ...
                var settings = {
                    "url": "../sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" +
                        image_selected + "&accesskey=12345",
                    "method": "GET",
                    "timeout": 0,
                };
    ...
    $('#d2').on('click', ".no_tracker", function() {
        ...
        if (!aa.is('.bg-light')) {
            ...
            if (image_selected.indexOf(my_id) == -1) {
                ...
                // alert(lat)   
                var lng = parseFloat($(this).data('geo-long'));
                var id = $(this).data('idds');
    ...
    function activity() {
        var settings = {
            "url": "../sitara_api/sitara_sap_api/running_count.php?vehi=" + focused +
                "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function speedo(id) {
        var settings = {
            "url": "../sitara_api/sitara_sap_api/speed.php?vehi=" + id + "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function basedata(id) {
        ...
        var settings = {
            "url": "../sitara_api/sitara_sap_api/base_data.php?vehi=" + id +
                "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function drawpath() {
        var settings = {
            "url": "../sitara_api/sitara_sap_api/route.php?vehi=" + focused +
                "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function count() {
        var settings = {
            "url": "../sitara_api/sitara_sap_api/counts.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
        ...
        $.ajax(settings).done(function(response) {
            ...
            $("#total").html(
                ...
                data["total"] + '</b>');
            $("#total_without_tracker").html(
                '<i class="fas fa-exclamation-triangle align-middle d-block font-size-16" style="color: rgb(89, 7, 184);"></i><b>' +
                data["without_tracker"] + '</b>');
            $("#total_saps").html(
                '<i class="fas fa-tasks align-middle d-block font-size-16" style="color: rgb(89, 7, 184);"></i><b>' +
                data["total_saps"] + '</b>');
            $('#sap_update_date').text(data["sap_created_at"])
        });
    }
    </script>
    <!-- Gmaps file -->
