...
<body style="min-height: 700px;">
    ...
    function change_id() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/total.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function distributor() {
        ...
        $('#loading').show();
        $.ajax({
            url: "http://151.106.17.246:8080/sitara_api/sitara_sap_api/distributor.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
    ...
    function cartraige() {
        $.ajax({
            url: "http://151.106.17.246:8080/sitara_api/sitara_sap_api/cartraige.php?accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
            success: function(response) {
    ...
    function get_sao_trips(vehi) {
        // alert(vehi)
        $.ajax({
            url: "http://151.106.17.246:8080/sitara_api/sitara_sap_api/get_trips.php?accesskey=12345&vehi=" +
                vehi + "",
            method: "GET",
            timeout: 0,
            cache: false,
    ...
    $('#dis').on('click', ".ss2", function() {
        ...
        $('#loading').show();
        $.ajax({
            url: "http://151.106.17.246:8080/sitara_api/sitara_sap_api/end_user.php?dis=" + my_id +
                "&accesskey=12345",
            method: "GET",
            timeout: 0,
            cache: false,
    ...
    $(document).ready(function() {
        ...
        var refreshId = setInterval(function() {
            if (vehcile_selection.length == 1) {
                ...
                var settings = {
                    "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" +
                        vehcile_selection + "&accesskey=12345",
                    "method": "GET",
                    "timeout": 0,
                };
                //console.log("http://151.106.17.246:8080/sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" + vehcile_selection + "&accesskey=12345");
        ...
        $("#myInput").keyup(function() {
            ...
            ///Vehicle Search
            var settings = {
                "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/vehi_search.php?accesskey=12345&str=" +
    ...
    function updated_data() {
        ...
        if (focused == 0) {
            ...
            var settings = {
                "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" + focused +
                    "&accesskey=12345",
                "method": "GET",
                "timeout": 0,
            };
            //console.log("http://151.106.17.246:8080/sitara_api/sitara_sap_api/selected_vehicle.php?vehi=" + focused + "&accesskey=12345");
    ...
    $("#stop").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/stopped_vehicle.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#nodata").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/nodata.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#running").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/running.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#idle").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/idle.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    $("#total_without_tracker").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/with_out_tracker.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
        ...
        $.ajax(settings).done(function(response) {
            ...
            for (i = 0; i < l; i++) {
                ...
                div = '' +
                    '                                                   <li class="list-unstyled " >' +'<div class="card p-0 no_tracker mb-1 " data-geo-lat="' +data[i]['lat'] + '" data-geo-long="' + data[i]['lng'] + '" data-geo-long="' + data[i]['idds'] + '" data-car_name="' + data[i]['name'] + '" data-idds="' + data[i]['id'] + '"  id="' +
                    data[i]['id'] + '">' +
                    '                                                            <div class="card-body p-2">' +
                    '                                                                <div class="row p-0 mb-0 ">' +
                    '                                                                    <div class="col-lg-5">' +
    ...
    $("#inactive").click(function() {
        ...
        ///Vehicle Search
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/inactive.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function activity() {
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/running_count.php?vehi=" + focused +
                "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function speedo(id) {
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/speed.php?vehi=" + id + "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function basedata(id) {
        ...
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/base_data.php?vehi=" + id +
                "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function drawpath() {
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/route.php?vehi=" + focused +
                "&accesskey=12345",
            "method": "GET",
            "timeout": 0,
        };
    ...
    function count() {
        var settings = {
            "url": "http://151.106.17.246:8080/sitara_api/sitara_sap_api/counts.php?accesskey=12345&user=" +
                user_id + "",
            "method": "GET",
            "timeout": 0,
        };
