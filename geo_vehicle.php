...
<head>
    ...
    <title>Go Get Going With Go  ROUTES</title>
...
$result_in = mysqli_query($db,"SELECT geo.*,(SELECT count(*) as count_vehi FROM geo_in_check where geo_id=geo.id) as vehi_count FROM geofenceing as geo;");
                                        ...
                                        <table id="html5-extension" class="table table-hover non-hover"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $row["vehi_count"]; ?> vehicle
                                                    </td>
    ...
    function initMap() {
        ...
        function marker_creation(lat, lng, consignee) {
            ...
            var infowindow = new google.maps.InfoWindow({
                content: '<p>Details:' + '<p>Vehicle # :' + consignee + '</p>'
            });
