...
<body class="sidebar-noneoverflow starterkit">
    ...
    <div class="main-container" id="container">
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="container-fluid bg-light">
                        <div class="row">
                            <div class="col-md-12">
                                <div id="loader" style="display: none;text-align: center;"><img
                                        src="https://tbphelps.com/skin/frontend/ultimo/default/images/wating.gif"
                                        alt=""></div>

                            </div>
                            <div class="col-md-12">
                                <table id="myTable" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
        ...
        function fetchtable() {
            ...
            fetch("get_all_inlist_vehicle.php",
                    requestOptions)
                ...
                .then(response => {
                    ...
                    $.each(response, function(index, data) {
                        ...
                        var del = `<a
                                                        ...
                                                        href="delete_inlist_vehicle.php?id=${data.uniqueId}"
                        ...
                        var btns = `<button class="btn remove_style"
                                                        id="edit_btn_${data.uniqueId}"
                                                        onclick='check_status(${data.uniqueId})'>
                        ...
                        if (status == '1') {
                            swi = `<label
                                                                    ...
                                                                    <input id="toggle_${data.uniqueId}"
                                                                        type="checkbox" checked="" name=toggle
                                                                        value="${data.uniqueId}" data-toggle="toggle"
