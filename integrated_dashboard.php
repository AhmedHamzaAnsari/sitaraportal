...
<head>
    ...
    $result_transit=mysqli_query($db, "SELECT * FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
    join users_devices_new as ud on ud.devices_id=dc.id
    where  ss.deliveryno not in(SELECT deliveryno from sapend)  and ss.status=0 and dc.time >='$prev_date' and ud.users_id='$user_id' order by ss.id desc;");
    $count_t_transit = mysqli_num_rows($result_transit);


    $result_inte=mysqli_query($db, "SELECT * FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join users_devices_new as ud on ud.devices_id=dc.id
    where ss.tlno not IN(SELECT name from devicesnew) and ss.deliveryno not in(SELECT deliveryno from sapend)  and ss.status=0 and dc.time >='$prev_date' and ud.users_id='$user_id' order by ss.id desc;");
    $count_t_not_integrated = mysqli_num_rows($result_inte);

    
    $result_not_inte=mysqli_query($db, "SELECT * FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
    join users_devices_new as ud on ud.devices_id=dc.id
    where ss.tlno IN(SELECT name from devicesnew) and ss.deliveryno not in(SELECT deliveryno from sapend)  and ss.status=0 and dc.time >='$prev_date' and ud.users_id='$user_id' order by ss.id desc;");
    $count_t_integrated = mysqli_num_rows($result_not_inte);


    $result12=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.* FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     where tlno IN(SELECT name from devicesnew) and dc.time >='$prev_date' and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc;");
    $countdata = mysqli_num_rows($result12);

    $result13=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.* FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     where tlno IN(SELECT name from devicesnew) and dc.speed > 0 and dc.time >='$prev_date' and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc;");
     $count_move = mysqli_num_rows($result13);

    $result14=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.* FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     where tlno IN(SELECT name from devicesnew) and dc.speed = 0 and dc.time >='$prev_date'  and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc");
    $count_stop = mysqli_num_rows($result14);


    $result15=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.* FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     where ss.tlno IN(SELECT name from devicesnew) and dc.time <='$prev_date' and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc");
    $countnr = mysqli_num_rows($result15);

    $result16=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.* FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     where tlno IN(SELECT name from devicesnew) and dc.speed >= 60 and dc.time >='$prev_date' and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc");
    $count_speed = mysqli_num_rows($result16);


    $result17=mysqli_query($db, "SELECT  distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.* FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     where tlno IN(SELECT name from devicesnew) and dc.speed = 0 and dc.ignition ='On' and dc.time >='$prev_date'  and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc;");
    $count_idel = mysqli_num_rows($result17);
    
    $result18=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,dc.trackername as vehicle_make,ss.*,gc.consignee_name FROM sapstart as ss
    join devicesnew as dc on dc.name=ss.tlno
     join old_sapno as os on os.sap_id=ss.id
     join users_devices_new as ud on ud.devices_id=dc.id
     join geo_in_check as gc on gc.veh_id=dc.id
     where ss.tlno IN(SELECT name from devicesnew) and gc.geotype='black spote' and dc.time >='$prev_date' and ss.deliveryno NOT IN(select deliveryno from sapend)  and ss.status=0 and ud.users_id='$user_id' order by ss.id desc");
    
    $blacking = mysqli_num_rows($result18);


    $result19=mysqli_query($db, "SELECT distinct(dc.name),dc.name,dc.time,dc.speed,dc.location as vlocation,dc.lat as latitude,dc.lng as longitude,sapstart.*,os.old_sapno FROM sapstart 
    join devicesnew as dc on dc.name=sapstart.tlno
    join old_sapno as os on os.sap_id=sapstart.id
    join users_devices_new as ud on ud.devices_id=dc.id
    where tlno IN(SELECT name from devicesnew) and ud.users_id='$user_id' order by sapstart.id desc");
    $diverse = mysqli_num_rows($result19);
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#4a5870  !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $count_t_transit; ?>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#3ba6b7 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;">
                                                    <?php echo $count_t_integrated; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#eaaf72 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;">
                                                    <?php echo $count_t_not_integrated; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#24245b !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $countdata; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#3b78b7 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $count_move;?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#e6b730 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $count_idel; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#e62e2d !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $count_speed ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#ea7372 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $count_stop; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#421515 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $blacking; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#c34c9c !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h3 style="color: #fff;"><?php echo $countnr; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
