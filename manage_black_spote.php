                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a  onclick="return confirm('Are you sure to Delete this Geofence ?');" href="delete_poi.php?id=<?php echo $row['id']; ?>&type=black" data-toggle="tooltip"
