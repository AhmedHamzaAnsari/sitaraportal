...
if($_SESSION['prive']==='Cartraige'){
    ...
    $result = mysqli_query($db,"SELECT dc.* FROM users_devices_new as ud join devicesnew as dc on ud.devices_id=dc.id where ud.users_id='$sess_id'");
}
else{
    $result = mysqli_query($db,"SELECT * FROM devicesnew;");
                            ...
                            ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $row["trackername"]; ?></td>
                                                
                                             

                                                <!-- <td class="text-center"><a name="edit"
                                                        id="<?php echo $row["uniqueId"]; ?>" class="edit_data"
                                                ...
                                                <td class="text-center">
                                                    <?php if($_SESSION['prive']==='Admin' || $_SESSION['prive']==='Distributor'){?>
                                                    <a
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" style="color:#000" id="title_edit">Add Vehicle</h5>
                                            ...
                                            <form method="post" id="insert_form" enctype="multipart/form-data">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="cc_no" name="cc_no"
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit_data', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#cname').val(data.name);
                    $('#engine_no').val(data.description);
                    $('#chassis_no').val(data.devicetype1);
                    // $('#make').val(data.vehicle_make);
                    $('#model').val(data.Vehicle_Model);
                    $('#color').val(data.Vehicle_Color);
                    $('#cc_no').val(data.Vehicle_CC);
        ...
        $('#insert_form').on("submit", function(event) {
            ...
            if ($('#cname').val() == "") {
                ...
                $.ajax({
                    url: "ajax_edit/update_device_detail.php",
                    method: "POST",
