...
$resultss2 = mysqli_query($db,"SELECT * FROM `geofenceing` where geotype!='black Spote'");
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a  href="edit_consignee.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
                                            ...
                                            <td class="text-center"><a  onclick="return confirm('Are you sure to Delete this Geofence ?');" href="delete_poi.php?id=<?php echo $row['id']; ?>&type=fence" data-toggle="tooltip"
