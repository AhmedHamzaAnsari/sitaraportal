...
$result = mysqli_query($db,"SELECT rm.*,tm.driver_cnic,tm.driver_contact,tm.driver_helper_cnic,tm.driver_helper_contact,tm.trip_count,dc.name as device_name FROM receive_main as  rm 
inner join trip_main  as tm on rm.trip_id=tm.id
inner join devices as dc on tm.lorry_no=dc.uniqueId;");
