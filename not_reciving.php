...
$resultss = mysqli_query($db,"SELECT * FROM trip_main as tm  
                            ...
                            ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center car_upper"><?php echo $row["vehicle_name"]; ?></td>
                                                <td class="text-center"><?php echo $row["main_id"]; ?></td>
                                                ...
                                                <td class="text-center"><?php echo $row["consignee_contact_1"]; ?></td>
