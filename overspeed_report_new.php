...
$id = $_SESSION['userid'];
$devices = "SELECT * FROM users where privilege  IN('dashboard','Cartraige','End-User','Distributor','Admin') order by name asc;";
...
<body class="sidebar-noneoverflow starterkit">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-row mb-4">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control tagging js-example-basic-multiple"
                                            ...
                                            <div class="col-md-12">
                                                <!-- <button class="btn btn-info" style="float:right;display:none"
                                                    id="sending" data-toggle="modal" data-target="#zoomupModal"> Send
                                                    Mail </button> -->
                                            </div>
                                        </div>
                                    </div>
    ...
    function get_history() {
        ...
        if (lorry_number !== '' && from1 !== "" && to !== "") {
            $.ajax({
                url: 'get_overspeed_history_data.php',
                type: 'GET',
                data: {
                    id: lorry_number,
                    from: from1,
                    ...
                    if (data.length > 0) {
                        ...
                        data.forEach((row, index) => {
                            table.row.add([
                                ...
                                row.min_speed || "N/A",
                                row.max_speed || "N/A",
                                `<a href="veiw_alert.php?id=${row.id}" target="_blank" title="View Details">
    ...
    function send_mail() {
        ...
        $.ajax({
            url: 'sitara_schedule_email/sitara_email.php',
            type: 'POST',
            data: {
                check: v_id,
                from: from1,
