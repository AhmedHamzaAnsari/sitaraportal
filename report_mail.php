...
<?php
    ...
    $email_assign = mysqli_query($db,"SELECT * FROM email_scedule where user_id='$user_id';");
    ...
    if(isset($_POST['inserted'])){
        ...
        $sql = "INSERT INTO `report_email`(`name`, `email`,`user_id`,`contact`) VALUES ('$name', '$email','$user_id','$contact')";
            echo $sql;
                                                ...
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select id="user" name="user"
                                                            ...
                                                            <?php if($_SESSION['prive']!='Cartraige') {?>
                                                            <option value="sms_report">SMS Report</option>
