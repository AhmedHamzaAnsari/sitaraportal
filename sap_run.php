...
$id = $_GET['id'];
$qry = mysqli_query($db,"SELECT * FROM positions where vehicle_id='$id' order by id DESC limit 1"); // select query
...
<body class="sidebar-noneoverflow starterkit">
                                        ...
                                        <li class="list-group-item list-group-item-action">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="tx-inverse">Overspeed</h6>
                                                </div>
                                            </div>
                                        </li>
    ...
    function initMap() {
        ...
        var starttime = search_params.get('start');
        var endtime = search_params.get('end');
                ...
                if(i < len){
                    while (i < len) {
                        ...
                        $('#consignee_list').append(`<li class="list-group-item list-group-item-action">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="tx-inverse">"${location} at ${time}"</h6>
                                                    </div>
                                                </div>
                                            </li>`);
                    ...
                    $('#consignee_list').append(`<li class="list-group-item list-group-item-action">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="tx-inverse">No Overspeed</h6>
                                                </div>
                                            </div>
                                        </li>`);
                }
