...
ini_set('max_execution_time', -1);
	...
	if(isset($_GET['accesskey'])) {
		...
		if($access_key_received == $access_key){
			...
			join users_devices_new ud on dc.id = ud.devices_id where dc.speed=0 and dc.ignition = 'OFF' and ud.users_id = $user and dc.time >='$prev_date' order by dc.time desc";
