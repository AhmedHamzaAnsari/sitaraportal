...
function smtp_mailer($to, $time, $db,$api,$api_name)
{
    ...
    $mail->Subject = $api_name . ' API Not Working at ' . $time;		//Sets the Subject of the message
    $mail->Body = '<h1></h1> <h3>Hi ' . $to . '</h3><p> '.$api.' </p>';				//An HTML or plain text message body
