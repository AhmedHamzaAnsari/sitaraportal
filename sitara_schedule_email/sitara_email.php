...
//=====================================================================================================================
    ...
    if($if_vehi==='all'){
        $sql__devi="SELECT pos.device_id as uniqueId,pos.vehicle_id as name FROM positions as pos where speed>'55' and pos.time>'$from' and pos.time<'$tommorrow'  and power='1' group by pos.vehicle_id;";
    ...
    foreach ($vehi as $value) {
        // echo "$value <br>";
	    $sql__="SELECT pos.vehicle_id,pos.time,pos.speed,pos.vlocation,pos.latitude,pos.longitude FROM positions as pos where pos.device_id='$value' and  pos.time>'$from' and pos.time<'$tommorrow' and pos.power='1' order by pos.time asc;";
        ...
        $sql__2="SELECT MAX(pos.speed) as maxx,MIN(pos.speed) as minn FROM positions as pos where pos.speed>'55' and pos.device_id='$value' and  pos.time>'$from' and pos.time<'$tommorrow' and pos.power='1' order by pos.time asc;";
...
function fetch_customer_data($connect)
{
    ...
    if($v_id==='all'){
	    $query = "SELECT pos.device_id,pos.vehicle_id,pos.speed,pos.vlocation,pos.time,pos.latitude,pos.longitude FROM positions as pos where speed>'55' and pos.time>'$from' and pos.time<'$tommorrow'  and power='1'";
        $query;

    }
    else{
        $query = "SELECT pos.device_id,pos.vehicle_id,pos.speed,pos.vlocation,pos.time,pos.latitude,pos.longitude FROM positions as pos where speed>'55' and pos.time>'$from' and pos.time<'$tommorrow' and pos.device_id IN ({$v_id}) and power='1'";
