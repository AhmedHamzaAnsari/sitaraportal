                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <span id="api_span" style="display:none">
                                                            <!-- <input type="text" class="form-control" id="vehi_name_text"
                                                                ...
                                                                name="vehi_name_text" onchange="set_name(this)">
                                                                <option></option>
