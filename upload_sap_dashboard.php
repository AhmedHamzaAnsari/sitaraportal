...
<head>
    ...
    $result12=mysqli_query($db, "SELECT * FROM sap_data_upload where date(created_at)='$froming';");
    $count_t_loads= mysqli_num_rows($result12);

    
    $result14=mysqli_query($db, "SELECT * FROM sap_data_upload where date(created_at)='$froming' and status=0");
    $count_trip_end= mysqli_num_rows($result14);


    $result_trip_comp=mysqli_query($db, "SELECT * FROM sap_data_upload where date(close_time)='$froming' and status=1;");
    ...
    where da.created_at>=sa.created_at and (CASE
        ...
        END) and da.created_by='$user_id' and da.type IN ('Overspeed') group by da.id");
    ...
    where da.created_at>=sa.created_at and (CASE
            WHEN sa.close_time='' THEN da.created_at <= NOW()
            ELSE da.created_at <= sa.close_time
        END) and da.created_by='$user_id' and da.type IN ('Un-Authorized Stop') group by da.id");
    ...
    where da.created_at>=sa.created_at and (CASE
            WHEN sa.close_time='' THEN da.created_at <= NOW()
            ELSE da.created_at <= sa.close_time
        END) and da.created_by='$user_id' and da.type IN ('Night time violations') group by da.id");
    $count_trip_night= mysqli_num_rows($result_night);




    $result16=mysqli_query($db, "SELECT da.*,sa.delivery_no,dc.name as vehicle_no FROM sap_data_upload as sa
    join devicesnew as dc on dc.name=sa.tl_no
    join driving_alerts as da on da.device_id=dc.id
    where da.created_at>=sa.created_at and da.created_at<=sa.close_time and sa.status=1 and da.created_by=$user_id");
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:##80a1f1 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#000"> Total SAP Trip
                                                </h6>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#d6dce4 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#000"> On Trip
                                                </h6>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#fff2cc !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#000"> Trip Complete
                                                </h6>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#acb9ca !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#000"> Un-Authorized Stop</h6>

                                            </div>
                                            <div class="col-md-4">
                                                <h3 style="color: #000;"><?php echo $count_trip_blackspot; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_7">
                                    <div class="card-body" style="background:#ff0000 !important ;  cursor: pointer;"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6 class="card-user_name" style="color:#000"> Overspeed</h6>

                                            </div>
                                            <div class="col-md-4">
                                                <h3 style="color: #000;"><?php echo $count_trip_overspeed; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing" id="all_car">
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <center>
                                    <h3 style="color: #24245c;">All Trip</h3>
                                </center>
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">GI Posting Date</th>
                                            <th class="text-center">Sup. Plant Name</th>
                                            <th class="text-center">Receiving Plant</th>
                                            <th class="text-center">Recv. Plant Name</th>
                                            <th class="text-center">Material Group</th>
                                            <th class="text-center">Material No.</th>
                                            <th class="text-center">GI Qty.</th>
                                            <th class="text-center">Phy.Report Date</th>
                                            <th class="text-center">Rep. Doc. No.</th>
                                            <th class="text-center">Reported at OGRA</th>
                                            <th class="text-center">Actual Days</th>
                                            <th class="text-center">Over-Due Days</th>
                                            <th class="text-center">Planned Arrival Date</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $row["tl_no"]; ?></td>
                                            <td class="text-center"><?php echo $row["delivery_no"]; ?></td>
                                            <td class="text-center"><?php echo $row["gi_posting_date"]; ?></td>
                                            <td class="text-center"><?php echo $row["sub_plant_name"]; ?></td>
                                            <td class="text-center"><?php echo $row["receiving_plant"]; ?></td>
                                            <td class="text-center"><?php echo $row["receiving_plant_name"]; ?></td>
                                            <td class="text-center"><?php echo $row["material_group"]; ?></td>
                                            <td class="text-center"><?php echo $row["material_no"]; ?></td>
                                            <td class="text-center"><?php echo $row["gi_qty"]; ?></td>
                                            <td class="text-center"><?php echo $row["phy_report_date"]; ?></td>
                                            <td class="text-center"><?php echo $row["rep_doc_no"]; ?></td>
                                            <td class="text-center"><?php echo $row["reported_at_ogra"]; ?></td>
                                            <td class="text-center"><?php echo $row["actual_days"]; ?></td>
                                            <td class="text-center"><?php echo $row["over_due_days"]; ?></td>
                                            <td class="text-center"><?php echo $row["planned_arrival_date"]; ?></td>
