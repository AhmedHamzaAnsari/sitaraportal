<?php
    ...
    $qry_sms = mysqli_query($db,"SELECT * FROM sms_link where sub_id='$id__sms'"); // select query
...
<body class="sidebar-noneoverflow starterkit">
                    ...
                    <div class="col-md-3" id="collaps_col"
                        ...
                        <a href="javascript:void(0)" id="closebtn" onclick="closeNav()">&times;</a>
                            ...
                            <div class="widget-heading">
                                ...
                                <div class="wallet-balance">
                                    <p>Speed</p>
                                    <h5 class="" id="speeding"><span class="w-currency"> </span><?php echo $data11['speed']?> Km/hr</h5>
                                </div>
                                ...
                                <div class="wallet-balance">
                                    <p>Time</p>
                                    <h5 class="" id="timmming"><span class="w-currency"> </span><?php echo $data11['time']?> </h5>
                                </div>
                                <div class="wallet-balance">
                                    <p>Base</p>
    ...
    function initMap() {
        ...
        function create_consignee(lat, lng, consignee,eta,name) {
            ...
            var infowindow = new google.maps.InfoWindow({
                content: '<p>Details:</p>' + '<p>'+ name +' # :' + consignee + '</p>'+'<p>'+ time_type +' # :' + eta + '</p>'
            });
            marker.addListener('click', function() {
                infowindow.open(map, marker);
            });
